        ...
        <li key={nav.name}>
          {nav.subItems ? (
            ...
            nav.path && (
              <Link
                href={nav.path}
                className={`menu-item group ${isActiveGroup(nav.path) ? "menu-item-active" : "menu-item-inactive"}`}
              >
                <span
                  className={`menu-item-icon-size ${isActiveGroup(nav.path) ? "menu-item-icon-active" : "menu-item-icon-inactive"}`}
                >
                  {nav.icon}
                </span>
                {(isExpanded || isHovered || isMobileOpen) && (
